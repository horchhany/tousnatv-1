                                                ...
                                                <div class="post-block-style clearfix">
                                                    ...
                                                    <div class="post-content">
                                                        <h2 class="post-title title-medium" >
                                                               <a href="{{ route('visitor.article.detail', $article->id) }}">  {{ str_limit($article->title, 150) }}</a>
                                                        </h2>
                                    ...
                                    <div class="col-sm-12 ">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-7">
                                                <div class="Pagetext">
                                                    <h2 class="post-title title-medium">
                                                        <a href="{{ route('visitor.article.detail', $article->id) }}">{{ str_limit($article->title, 70) }}</a>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-7">
                                                        <h2 class="post-title title-medium" style="margin-top: -5px!important;">
                                                           <a href="{{ route('visitor.article.detail', $post->id) }}"> {{ str_limit($post->title,30) }}</a>
                                                        </h2>
                                                    </div>
                                                </div>
                                                </a>
